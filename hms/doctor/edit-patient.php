...
<div class="panel-body">
                    <form role="form" name="" method="post">
                             ...
                             <div class="form-group">
                                     ...
                                     <input type="text" name="patadmi" class="form-control"  value="<?php  echo $row['PatientAdmision'];?>" required="true">
                             </div>
                             <div class="form-group">
							 ...
							 <div class="form-group">
                                    ...
                                    <input type="text" name="fena" class="form-control"  value="<?php  echo $row['FechaNac'];?>" required="true" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
                                 </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                     <label for="fess">Fecha creacion</label>
                                     <input type="text" class="form-control"  value="<?php  echo $row['CreationDate'];?>" readonly='true'>
                             </div>
                             <?php } ?>
                             <button type="submit" name="submit" id="submit" class="btn btn-o btn-primary">Actualizar</button>
                    </form>
              </div>
         </div>
     </div>
