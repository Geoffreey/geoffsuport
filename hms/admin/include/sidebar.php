...
<nav>
						...
						<div class="navbar-title">
							<span>Navegasion principal</span>
						</div>
								...
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title">Especializaciones medicas</span>
										</a>
									</li>
									<li>
										<a href="add-doctor.php">
											<span class="title">Agregar medico</span>
										</a>
									</li>
									<li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="between-dates-reports.php">
											<span class="title">Reportes por fecha</span>
										</a>
									</li>
