...
<html lang="en">
	<head>
		<title>Recuperacion de contraseña para paciente</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> CaliTex | Recuperacion de contraseña para paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								Recuperacion de contraseña para paciente
							</legend>
							<p>
								Por favor ingrese su correo para recuperar su contraseña.<br />
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-right" name="submit">
									Reestablecer<i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
