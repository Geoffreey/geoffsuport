    ...
    return this.each(function () {
      ...
      function d() {
        var t,
          o,
          n = function (e) {
            s(t, e.pageX - o), p(), e.stopPropagation(), e.preventDefault();
          },
          r = function () {
            M.removeClass("ps-in-scrolling"), e(q).unbind(K("mousemove"), n);
          };
        U.bind(K("mousedown"), function (l) {
          (o = l.pageX),
            (t = U.position().left),
            M.addClass("ps-in-scrolling"),
      ...
      function f() {
        var t,
          o,
          n = function (e) {
            a(t, e.pageY - o), p(), e.stopPropagation(), e.preventDefault();
          },
          r = function () {
            M.removeClass("ps-in-scrolling"), e(q).unbind(K("mousemove"), n);
          };
        ...
        e(q).bind(K("keydown"), function (n) {
          if ((!n.isDefaultPrevented || !n.isDefaultPrevented()) && t) {
            ...
            if (r) {
              ...
              if (e(r).is(":input,[contenteditable]")) return;
            }
            var l = 0,
              i = 0;
            switch (n.which) {
        ...
        e(q).bind(K("selectionchange"), function () {
          ...
          e(window).bind(K("mousemove"), function (e) {
            if (i) {
              ...
              t.x < a.left + 3
                ? ((l.left = -5), M.addClass("ps-in-scrolling"))
                : t.x > a.right - 3
                ? ((l.left = 5), M.addClass("ps-in-scrolling"))
                : (l.left = 0),
                t.y < a.top + 3
      ...
      function T(t, o) {
        function n(e, t) {
          M.scrollTop(M.scrollTop() - t), M.scrollLeft(M.scrollLeft() - e), p();
        }
        function r() {
          h = !0;
        }
      ...
      function S() {
        p(),
          ...
          M.data("perfect-scrollbar-update", p),
